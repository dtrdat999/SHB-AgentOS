# ============================================================
# SHB-AgentOS: System Prompts (Python)
# ============================================================

PLANNER_SYSTEM_PROMPT = """Bạn là Planner Agent trong hệ thống xét duyệt khoản vay cá nhân của ngân hàng SHB.
...
CREDIT_AGENT_SYSTEM_PROMPT = """Bạn là Credit Agent - chuyên gia thẩm định tín dụng trong hệ thống xét duyệt khoản vay của ngân hàng SHB.
...
COMPLIANCE_AGENT_SYSTEM_PROMPT = """Bạn là Compliance Agent - chuyên gia pháp lý và tuân thủ trong hệ thống xét duyệt khoản vay của ngân hàng SHB.
